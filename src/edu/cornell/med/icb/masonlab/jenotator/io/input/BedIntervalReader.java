...
public class BedIntervalReader implements IntervalReader {
	protected TabbedFileReader reader;

	public BedIntervalReader(String filename) throws IOException {
		this.reader = new TabbedFileReader(filename);
	}
	
	public BedIntervalReader(File file) throws IOException {
		this.reader = new TabbedFileReader(file);
	}
	
	public BedIntervalReader(InputStream inputstream) throws IOException {
