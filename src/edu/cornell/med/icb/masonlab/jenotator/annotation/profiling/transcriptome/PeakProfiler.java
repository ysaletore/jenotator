...
public class PeakProfiler {
	...
	public PeakProfiler(IntervalTree transcripts) {
		this(transcripts, CountingMethod.ALL, MappingMethod.ALL,
				true, true, false, true, false, 0, null);
	}
	
	public PeakProfiler(IntervalTree transcripts, boolean plot5UTR, boolean plotCDS, boolean plotIntrons, 
	...
	public PeakProfiler(IntervalTree transcripts, CountingMethod countingMethod,
